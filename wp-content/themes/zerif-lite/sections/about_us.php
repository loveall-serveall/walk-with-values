	...
	<div class="container">
		...
		<div class="section-header">
			...
			if( !empty($zerif_aboutus_title) ):
				echo '<h2 class="white-text"><a href="http://www.walkwithvalues.org/exp/?page_id=10">'.__($zerif_aboutus_title,'zerif-lite').'</a></h2>';
			endif;
			?>
				...
				<li class="skill">
					...
					<?php
						...
						if( !empty($zerif_aboutus_feature1_title) ):
							echo '<h6 ><a href="http://www.walkwithvalues.org/exp/?page_id=10">'.__($zerif_aboutus_feature1_title,'zerif-lite').'</a></h6>';
						endif;
				...
				<li class="skill">
					...
					<?php
						...
						if( !empty($zerif_aboutus_feature2_title) ):
							echo '<h6><a href="http://www.walkwithvalues.org/exp/?page_id=10">'.__($zerif_aboutus_feature2_title,'zerif-lite').'</a></h6>';
						endif;
				...
				<li class="skill">
					...
					<?php
						...
						if( !empty($zerif_aboutus_feature3_title) ):
							echo '<h6><a href="http://www.walkwithvalues.org/exp/?page_id=10">'.__($zerif_aboutus_feature3_title,'zerif-lite').'</a></h6>';
						endif;
